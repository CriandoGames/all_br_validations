...
import 'package:all_br_validations/src/br_zod/br_zod.dart';
...
void main() {
  ...
  group('isRequired', () {
    ...
    test('rejeita string só espaços',
        () => expect(g.isRequired('   '), isFalse));
    test('aceita string com conteúdo',
        () => expect(g.isRequired('abc'), isTrue));
  ...
  group('hasMinLength', () {
    ...
    test('converte número para string',
        () => expect(g.hasMinLength(12345, 4), isTrue));
  });
  ...
  // ── phone ──────────────────────────────────────────────────
  group('isPhone', () {
    test('celular com DDD (11 dígitos)',
        () => expect(g.isPhone('11987654321'), isTrue));
    test('fixo com DDD (10 dígitos)',
        () => expect(g.isPhone('1133334444'), isTrue));
    test('celular formatado',
        () => expect(g.isPhone('(11) 98765-4321'), isTrue));
  ...
  group('isEquals', () {
    ...
    test('número vs string do mesmo valor',
        () => expect(g.isEquals(42, '42'), isTrue));
  });
  ...
  group('isDate', () {
    ...
    test('ISO 8601 válido',
        () => expect(g.isDate('2026-06-28T12:00:00'), isTrue));
    test('data inexistente 30/02',
        () => expect(g.isDate('30/02/2026'), isFalse));
    ...
    test('29/02/2023 (não bissexto)',
        () => expect(g.isDate('29/02/2023'), isFalse));
  });

  // ── isBefore / isAfter ─────────────────────────────────────
  group('isBeforeDate / isAfterDate', () {
    final ref = DateTime(2026, 6, 28);
    test('antes da data max',
        () => expect(g.isBeforeDate('27/06/2026', ref), isTrue));
    test('depois da data max',
        () => expect(g.isBeforeDate('29/06/2026', ref), isFalse));
    test('depois da data min',
        () => expect(g.isAfterDate('29/06/2026', ref), isTrue));
    test('antes da data min',
        () => expect(g.isAfterDate('27/06/2026', ref), isFalse));
  });
  ...
  group('BrZod — encadeamento fluente', () {
    ...
    test('custom — função arbitrária', () {
      final v =
          BrZod().custom((val) => val != 'admin', message: 'Reservado').build;
      expect(v('carlos'), isNull);
...
class _TestLocale implements ILocaleBrZod {
  ...
  @override
  String get invalidDate => 'DATE';
  @override
  String get invalidType => 'TYPE';
  @override
  ...
  @override
  String get cnpjAlfa => 'CNPJ_ALFA';
  @override
  String get cpfCnpj => 'CPF_CNPJ';
  @override
  String get cep => 'CEP';
  @override
  String get rg => 'RG';
  ...
  String get cnh => 'CNH';
  @override
  String get renavam => 'RENAVAM';
  @override
  String get pisPasep => 'PIS';
  @override
  String get tituloEleitor => 'TITULO';
  @override
  String get cns => 'CNS';
  @override
  String min(int n) => 'MIN_$n';
  @override
  String max(int n) => 'MAX_$n';
  @override
  String minDate(DateTime d) => 'MIN_DATE';
  @override
  String maxDate(DateTime d) => 'MAX_DATE';
}
